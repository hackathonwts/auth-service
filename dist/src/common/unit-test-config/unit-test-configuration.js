...
exports.UnitTestConfigurations = void 0;
const UnitTestConfigurations = () => ({
    PORT: 3030,
    ...
    MAIL_FROM_ADDRESS: 'zayla.devis@gmail.com',
...
exports.UnitTestConfigurations = UnitTestConfigurations;
