...
export class BaseRepository<T> {
  ...
  async saveMany(body: Partial<T>[]): Promise<HydratedDocument<T>[]> {
  ...
  async updateByField(data: UpdateQuery<T>, param: FilterQuery<T>): Promise<mongodb.UpdateResult> {
  ...
  async findOneAndUpdate(filter: FilterQuery<T>, data: UpdateQuery<T>): Promise<T> {
